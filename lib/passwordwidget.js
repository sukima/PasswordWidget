...
PasswordWidget.prototype.attach = function() {
  return this.attachTo(this._element);
};
...
PasswordWidget.prototype.attachTo = function(attachToElement) {
  ...
  // if (opt.showInfo)          { wrapper.add(this.infoButton()); }
  // if (opt.showMask)          { wrapper.add(this.showHideButton()); }
  // if (opt.showGenerateLink)  { wrapper.add(this.generateButton()); }
  // if (opt.showStrength)      { wrapper.add(this.strengthMeterBar()); }
  // if (opt.showStrengthText)  { wrapper.add(this.strengthMeterText()); }
  // if (opt.showBlinkenlights) { wrapper.add(this.blinkenlights()); }

  DOMBuilder.after(attachToElement, wrapper);
...
module.exports = Emitter(PasswordWidget);
