...
function PasswordWidget(selector, options) {
  this.element = (typeof selector === 'string') ?
    ...
    selector;
  if (!this.element || ('' + this.element.nodeName).toLowerCase() !== 'input') {
...
PasswordWidget.prototype.attach = function() {
  return this.attachTo(this.element);
};

// #attachTo {{{1
PasswordWidget.prototype.attachTo = function(element) {
  var dom = new DOMBuilder(this);
  var wrapper = dom.wrapper('password-widget');

  dom.after(wrapper, element);
  return this;
};
// }}}1
